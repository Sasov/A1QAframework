...
import onliner.test.forms.OnlinerProductsForm;
...
public class OnlinerTest extends BaseTest {
    ...
    public void runTest() throws InterruptedException {
        ...
        logger.step(7);
        OnlinerProductsForm productsForm = new OnlinerProductsForm();
        productsForm.checkAllProducts(brand, price, year, minDiagonal, maxDiagonal);
